...
Десктопний WPF-додаток для адміністрування та моніторингу серверної інфраструктури домену **SANTA**. Написаний на C# / .NET 8, використовує патерн MVVM та Microsoft Generic Host для управління lifecycle фонових сервісів.
